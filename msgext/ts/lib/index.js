...
const messageExtensionBot_1 = require("./messageExtensionBot");
// Create HTTP server.
...
const messageExtensionBot = new messageExtensionBot_1.MessageExtensionBot();
// Listen for incoming requests.
server.post('/api/messages', (req, res) => {
    adapter.processActivity(req, res, (context) => __awaiter(void 0, void 0, void 0, function* () {
        // Route to main dialog.
        yield messageExtensionBot.run(context);
    }));
});
